...
Para entender mejor el desarrollo del detector de objetos sse hizo una investigación previa de un clasificador de objetos.
Se explica con más detalle aquí [clasificador](https://github.com/Alejandromndza/TensorFlowResearch/blob/master/Clasificador.md)
